...
public class Database extends SQLiteOpenHelper {
    private static String DB_NAME = "DBGame.db";
    ...
    public Database(Context context) {
        ...
        File file = new File(DB_PATH+"DBGame.db");
        if(file.exists())
            openDataBase();
    ...
    public List<Question> getQuestionMode(String mode) {
        ...
        Cursor c;
        int limit = 0;
        if (mode.equals(Level.MODE.EASY.toString())) {
            limit = 10;
        } else if(mode.equals(Level.MODE.MEDIUM.toString())) {
            limit = 20;
        } else {
            limit = 30;
        }
